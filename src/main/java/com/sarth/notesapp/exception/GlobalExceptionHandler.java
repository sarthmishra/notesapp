...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NoteNotFoundException.class)//Ye method-level annotation batata hai: "Jab bhi kahin NoteNotFoundException throw ho, is method ko chalao use handle karne ke liye."
